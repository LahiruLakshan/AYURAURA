...
import 'package:stress_management/pages/camera_page/video_player.dart';
...
import '../../widgets/camera_state.dart';
          ...
          children: [
            ...
            ValueListenableBuilder<int>(
              ...
              builder: (context, val, child) {
                final durationValue = val?.toDouble() ?? 0.0; // Ensure non-null value
                return TweenAnimationBuilder<double>(
                  duration: Duration(milliseconds: isRecording ? 1100 : 0),
                  tween: Tween<double>(
                    begin: isRecording ? 1 : 0,
                    end: isRecording ? durationValue + 1 : 0,
                  ),
                  curve: Curves.linear,
